...
class circle
{
	...
	double volume = 4 * Math.PI * Math.pow (radius,3)/3;
		System.out.println("Circle volume is : "+ volume);
		
	double SurfaceArea = 4 * Math.PI * Math.pow (radius,2);
		System.out.println("Circle Surface Area is : "+ SurfaceArea);
	}
}
```
```
D:\E040>java java.java
Enter The Radius of Circle : 18
Circle Area is  : 1017.8760197630929
Circle circumference is : 113.09733552923255
Circle volume is : 24429.02447431423
Circle Surface Area is : 4071.5040790523717
```
# 程式閱讀題==>
 ```
 //package ex02;
